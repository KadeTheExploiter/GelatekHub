...
function Library:Create(text)
	...
	function Stuff:MakeTab(name)
		...
		function Stuff:MakeLabel(nenene)
		...
		function Stuff:MakeButton(nane, callback)
		...
		function Stuff:MakeToggle(gjfdgkjfdglf,callback)
		...
		function Stuff:MakeTextBox(namegfrsjghf, callback)
